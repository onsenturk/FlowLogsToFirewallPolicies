...
4. Record discovered subscriptions, workspaces used or considered, confirmed VNet scope, enabled versus not-enabled flow-log status when that output was produced, evidence-source classification, and any blocking gaps that affect interpretation.
