...
2. The confirmed VNet scope that will be carried into the request artifacts, including evidence source by VNet, covered VNets, and uncovered VNets when known
3. The specific files that will be created, including `output-log-<region>.md` when output capture is requested
